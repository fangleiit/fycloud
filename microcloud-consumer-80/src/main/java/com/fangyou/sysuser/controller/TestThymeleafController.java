...
public class TestThymeleafController {
    ...
    public String helloIndex(ModelMap modelMap){
        ...
        List<DeptVo> depts = JSONObject.parseArray(JSON.toJSONString(JSONObject.parseArray(JSON.toJSONString(restTemplate.exchange("http://dept8010/dept/list/", HttpMethod.GET,request,List.class).getBody()),DeptVo.class)),DeptVo.class);
    ...
    public String date(ModelMap modelMap){
        ...
        HttpEntity<Object> request = new HttpEntity<Object>(headers);
        List<DeptVo> deptVos = JSONObject.parseArray(JSON.toJSONString(restTemplate.exchange("http://dept8010/dept/list/",HttpMethod.GET,request,List.class).getBody()),DeptVo.class);
        modelMap.addAttribute("depts",deptVos);

import com.fangyou.Festful8003_StartSpringCloudApplication;
...
@SpringBootTest(classes = Festful8003_StartSpringCloudApplication.class)
...
public class MessageControllerTest {
    ...
    public void getMessage() throws Exception {
        String mvcString = mockMvc.perform(MockMvcRequestBuilders.get("/message/6"))
                .andReturn().getResponse().getContentAsString();
        System.out.println("Result === " + mvcString);
    }
